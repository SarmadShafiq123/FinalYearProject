...
import { getStats, getAllRequests, approveRequest, rejectRequest } from "../api/requests.api";
  ...
  return (
    <div className="p-6 overflow-y-auto flex-1">
      <div className="mb-8">
        ...
        <p className="text-sm text-zinc-500 mt-1">Overview of CloudStore system</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard label="Storage Used" value={stats ? formatBytes(stats.totalStorage) : "—"} />
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr>
                {["Name", "Email", "Plan", "Date", "Status", "Actions"].map((h) => (
                  <th
                    key={h}
