...
const Alerts = () => {
  ...
  const [sendingTo, setSendingTo] = useState(null); // 'single' or 'multiple'
  ...
  const sendAlert = async (userIds) => {
    ...
    try {
      const endpoint =
        userIds.length === 1
          ? "/api/alerts/send-to-user"
          : "/api/alerts/send-to-multiple";
  ...
  const alertSeverity = ALERT_SEVERITIES.find(
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-zinc-500 transition-colors resize-none"
                />
              </div>
              ...
              <div className="border-t border-zinc-800 pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="/pricing"
                    className="bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-zinc-500 transition-colors"
                  />
                  <input
                    type="text"
                    name="actionLabel"
              ...
              <div className="border-t border-zinc-800 pt-4">
                ...
                <div
                  className={`p-4 rounded-lg border ${
                    alertSeverity?.color || "bg-blue-500/10 text-blue-400"
                  } border-current/20`}
                >
