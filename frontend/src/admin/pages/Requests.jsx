...
const Requests = () => {
  ...
  const handleApprove = (r) => {
    setConfirmModal({
      type: "approve",
      request: r,
      title: r.userId ? "Approve renewal request?" : "Approve this request?",
      description: r.userId
        ? `This will renew the existing user's plan and restore their locked files within 45 days.`
        : `An account will be created and credentials emailed to ${r.email}`,
    });
  };
      ...
      if (confirmModal.type === "approve") {
        ...
        toast.success(
          confirmModal.request.userId
            ? "Renewal approved and locked files restored."
    ...
    <div className="p-6 overflow-y-auto flex-1">
      <div className="mb-6">
        ...
        <p className="text-sm text-zinc-500 mt-1">
          Manage access requests and payments
        </p>
      </div>
